...
model = AutoModel.from_pretrained(model_name, token="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")
tokenizer = AutoTokenizer.from_pretrained(model_name, token="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")
